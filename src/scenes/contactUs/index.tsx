        ...
        <motion.div onViewportEnter={()=> setSelectedPage(SelectedPage.ContactUs)}>
            ...
            variants={{
                ...
                >
                    <form 
                    target="_blank"
                    action="http://formsubmit.co/adedamolajose@gmail.com"
                    onSubmit={onSubmit}
                    method="POST"
                    >
                        ...
                        {errors.name && (
                            <p className="mt-1 text-primary-500">
                                ...
                                {errors.name.type === 'maxLength' && 'Max character exceeded'}
                            </p>
                        )}
                        ...
                        {errors.message && (
                            <p className="mt-1 text-primary-500">
                                ...
                                {errors.message.type === 'maxLength' && '2000 Max character exceeded'}
                            </p>
                        )}
